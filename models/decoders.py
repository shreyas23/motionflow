...
class FlowDispPoseDecoderSmall(nn.Module):
    def __init__(self, ch_in, num_refs=1, use_mask=True, use_bn=False):
        super(FlowDispPoseDecoderSmall, self).__init__()
...
class JointContextNetworkSmall(nn.Module):
    def __init__(self, ch_in, num_refs = 1, use_mask=True, use_bn=False):
        super(JointContextNetworkSmall, self).__init__()
...
class FlowDispPoseDecoderFull(nn.Module):
    def __init__(self, ch_in, num_refs=1, use_mask=True, use_bn=False):
        super(FlowDispPoseDecoderFull, self).__init__()
        ...
        self.conv_sf = conv(64, 3, use_relu=False, use_bn=False)
        self.conv_d1 = conv(64, 1, use_relu=False, use_bn=False)

        self.convs_pose = conv(64, num_refs * 6, kernel_size=1, use_relu=False, use_bn=False)

        if use_mask:
            self.convs_mask = conv(64, 1, use_relu=False, use_bn=False)
...
class JointContextNetworkFull(nn.Module):
    def __init__(self, ch_in, num_refs = 1, use_mask=True, use_bn=False):
        super(JointContextNetworkFull, self).__init__()
        ...
        self.conv_sf = conv(64, 3, use_relu=False, use_bn=False)
        self.conv_d1 = nn.Sequential(
            conv(64, 1, use_relu=False, use_bn=False),
            torch.nn.Sigmoid()
        )
        self.convs_pose = conv(64, num_refs * 6, kernel_size=1, use_relu=False, use_bn=False)
