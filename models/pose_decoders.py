...
class PoseNet(nn.Module):
    ...
    def __init__(self, num_input_images=2, in_ch=3, use_bn=False):
        ...
        self.conv0 = Conv(in_ch*(self.num_input_images), in_ch*(self.num_input_images), kernel_size=3, stride=2, use_bn=use_bn)
        self.conv1 = Conv(in_ch*(self.num_input_images), conv_planes[0], kernel_size=7, stride=2, use_bn=use_bn)
