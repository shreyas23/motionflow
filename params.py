...
class Params:
    def __init__(self):
        ...
        self.parser.add_argument('--no_pose_context', type=bool, default=False, help="whether to use consensus mask in training procedure")
        ...
        self.parser.add_argument('--feat_disc_w', type=float, default=0.0, help='mask consensus weight')
