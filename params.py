...
class Params:
    def __init__(self):
        ...
        self.parser.add_argument('--feat_sm_w', type=float, default=1e-3, help='mask consensus weight')
        self.parser.add_argument('--feat_disc_w', type=float, default=1e-3, help='mask consensus weight')
