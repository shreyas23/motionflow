...
class MonoIterNoCV(nn.Module):
    def __init__(self, args):
        super(MonoIterNoCV, self).__init__()
        ...
        for l, ch in enumerate(self.num_chs[::-1]):
            ...
            if l == 0:
                ...
                num_ch_in = self.dim_corr + ch + 32 + 3 + 1 + 6 + 1
    ...
    def run_pwc(self, input_dict, x1_raw, x2_raw, k1, k2):
        ...
        for l, (x1, x2) in enumerate(zip(x1_pyramid, x2_pyramid)):
            ...
            if l == 0:
                ...
                x2_out, flow_b, disp_l2, mask_l2, pose_b, pose_b_out = self.flow_estimators[l](torch.cat([out_corr_relu_b, x2], dim=1))
