...
from utils.helpers import Warp_SceneFlow
...
class MonoDepthSFModel(nn.Module):

    def __init__(self, args):
        super(MonoDepthSFModel, self).__init__()
        ...
        self.context_network = ContextNetworkSF(in_chs=(self.sf_out_chs + 3 + 1))
