...
parser.add_argument('--pose_lr_w', type=float, default=0.5, help='mask consensus weight')
parser.add_argument('--mask_lr_w', type=float, default=0.5, help='mask consensus weight')
