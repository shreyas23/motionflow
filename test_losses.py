...
class Loss_SceneFlow_SelfSup(nn.Module):
    ...
    def forward(self, output_dict, target_dict):
        ...
        for ii, (sf_f, sf_b, disp_l1, disp_l2, disp_r1, disp_r2, pose_f, pose_b, mask_l1, mask_l2) in enumerate(zip(output_dict['flows_f'], 
            ...
            loss_mask_sum = loss_mask_sum + mask_reg_loss * self.mask_reg_w + mask_sm_loss * self.mask_sm_w + mask_census_loss * self.mask_cons_w
        ...
        # finding weight
        f_loss = (loss_sf_sum.detach() + loss_pose_sum.detach()) / 2.0
